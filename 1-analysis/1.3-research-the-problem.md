...
| Feature              | Justification                                            |
| -------------------- | -------------------------------------------------------- |
| Feature description. | Reason why I may/may not be able to include the feature. |
{% endtab %}

{% tab title="Features I won't include" %}
| Feature | Justification                                                                                                                                                                                                                                                                                                                                                                      |
| ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Timer   | Super Mario Bros includes a timer wich gives you a time limit for each level. I would prefer to leave each level with no time limit to give those who are younger and therefore maybe worse at the game a chance to still progress without having to spend hours practicing the game. As a result of this, I will include harder levels and more opponents as the game progresses. |
{% endtab %}
{% endtabs %}
